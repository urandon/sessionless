...
| #96 | [Native macOS YDB](native-macos-ydb.md) | Native arm64 remains a no-go; a pinned Darwin x86_64/Rosetta Dockerless fallback was built, proved, measured, packaged, and cleaned up as an opt-in developer path. |
