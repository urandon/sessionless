...
func reviewedProviderFixtures(t *testing.T) []FixtureV1 {
	...
	return []FixtureV1{
		...
		providerFixture(t, providerFixtureProfile{fixtureID: "codex-openrouter-environment", backendKind: domain.HarnessBackendCodexOpenRouterV1, artifactKind: domain.HarnessArtifactExecutableV1, nativeProtocol: "codex-jsonl.v1", deliveryKind: domain.ProviderCredentialDeliveryEnvironmentV1, resourceKind: domain.ProviderResourceRouterAccountV1, resourceID: "openrouter-account-a", modelVendorID: "stealth", modelID: "stealth/ox-alpha", transportKind: domain.ProviderTransportLocalCLIV1, transportProvider: "codex", upstreamProvider: "stealth", endpointID: "openrouter-responses", billingKind: domain.ProviderBillingRouterAccountV1}),
