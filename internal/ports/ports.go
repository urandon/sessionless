...
const (
	...
	IDProviderCredentialMutation IDKind = "provider_credential_mutation"
	...
	IDAttachedWorkerActionPlan   IDKind = "attached_worker_action_plan"
	IDAttachedWorkerAction       IDKind = "attached_worker_action"
)
